        ...
        <div className={styles.content}>
          ...
          <ul className={styles.list}>
            ...
            <li>
              ...
              Application in Angular utilizing Angular Universal which included
              server-side rendering and pre-rendering.
            </li>
            <li>
              Tweaked the Angular build process using gulp and webpack. to
              fingerprint static assets for cache busting to ensure users always
              see the latest version of the web application.
            </li>
            <li>
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <ul className={styles.list}>
            ...
            <li>
              Built responsive and usable web applications.
            </li>
            <li>
              Built a WAR of Angular and Spring Boot application using Maven and
              Deployed the integrated application on Tomcat.
            </li>
            <li>
